...
<template>
  <div class="main">
    ...
    <EpTableProBar title="部门列表" :loading="loading" :tableRef="tableRef" :dataList="dataList" @refresh="onSearch">
      <template #buttons>
        ...
        >
          ...
          <el-table-column label="状态" align="center" prop="status" width="80">
            <template #default="scope">
              <el-tag :size="size" :type="scope.row.status === 0 ? 'danger' : 'success'" effect="plain">
