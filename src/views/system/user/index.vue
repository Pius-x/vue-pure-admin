...
<template>
  <div class="main flex">
    ...
    <div class="flex-1 ml-4">
      ...
      <EpTableProBar title="用户管理" :loading="loading" :dataList="dataList" @refresh="onSearch">
        <template #buttons>
          <el-button type="primary" :icon="useRenderIcon('add')"> 新增用户 </el-button>
        </template>
        <template v-slot="{ size, checkList }">
          ...
          >
            ...
            <el-table-column v-if="checkList.includes('序号列')" type="index" label="序号" align="center" width="70" />
            <el-table-column label="用户编号" align="center" prop="id" />
            <el-table-column label="用户名称" align="center" prop="username" />
            <el-table-column label="用户昵称" align="center" prop="nickname" />
            <el-table-column label="性别" align="center" prop="sex">
              <template #default="scope">
                <el-tag :size="size" :type="scope.row.sex === 1 ? 'danger' : ''" effect="plain">
                  {{ scope.row.sex === 1 ? "女" : "男" }}
                </el-tag>
              </template>
            </el-table-column>
            ...
            <el-table-column label="状态" align="center" width="130" prop="status">
              <template #default="scope">
                <Switch
